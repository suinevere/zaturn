/*----------------------
 ...
 |   Pauses the title-menu CD-DA track, fades in a fixed black-backdrop/
 |   white-text retro-OS boot screen together with LOADCD.PCM, and types out
 |   the boot sequence (loading_text.h) with the game's title substituted in.
...
/*----------------------
 ...
 | Description: Pauses the menu track, blacks the screen out, loads LOADCD.PCM,
