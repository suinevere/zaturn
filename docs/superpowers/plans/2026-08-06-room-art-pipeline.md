...
```json
{
  ...
  "UNDRGRND": { "adjectives": ["dim", "damp", "narrow", "deep", "torchlit", "carved", "winding", "echoing"],
                ...
                "exclude_nouns": [], "target": 99 },
  "WATER":    { "adjectives": ["still", "rushing", "moonlit", "misty", "deep", "clear", "reflective", "cold", "glassy", "storm-tossed"],
                "donors": ["WATER"], "extra_nouns": ["waterfall", "reservoir", "estuary", "millpond", "rapids", "fjord", "lagoon", "creek bed"],
                "exclude_nouns": [], "target": 99 },
  ...
  "DUNGN":    { "adjectives": ["stone", "torchlit", "grim", "vaulted", "barred", "cold", "ancient", "oppressive"],
                ...
                "exclude_nouns": [], "target": 99 },
  "DESERT":   { "adjectives": ["arid", "sunbaked", "vast", "windswept", "golden", "cracked", "empty", "hazy", "scorched", "moonlit"],
                "donors": ["DESERT"], "extra_nouns": ["oasis", "salt flat", "sandstone canyon", "sand sea", "wadi", "mesa", "scrubland", "caravan track"],
                "exclude_nouns": [], "target": 99 },
